...
modelo="Resultado" #Nombre de la carpeta donde se guardan las fotos (Datos de entrada).
...
camara = cv.VideoCapture('./Data/Messi2.mp4')

ruido=cv.CascadeClassifier("./Ruido/data/haarcascades/haarcascade_frontalface_default.xml")
id=0
...
while True:
	...
	if id==351: #Este if detiene la creación de imágenes al llegar a la imagen 350.JPG y cierra el programa.
		break
camara.release()
